...
- (UIImage*) imageWithAutoLevels {
    ...
    return [self imageWithAutoLevelsWithRatio:1.0f];
}

- (UIImage*) imageWithAutoLevelsWithRatio:(CGFloat)ratio
{
    CGFloat whitePoint;
    CGFloat blackPoint;
    ...
    blackPoint -= (blackPoint / 20.0f) * ratio;
    whitePoint -= (whitePoint / 10.0f) * ratio;
