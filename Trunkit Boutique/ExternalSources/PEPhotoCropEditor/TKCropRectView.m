...
@interface TKCropRectView ()<TKResizeControlViewDelegate>

@property (nonatomic) TKResizeControl *topLeftCornerView;
@property (nonatomic) TKResizeControl *topRightCornerView;
@property (nonatomic) TKResizeControl *bottomLeftCornerView;
@property (nonatomic) TKResizeControl *bottomRightCornerView;
@property (nonatomic) TKResizeControl *topEdgeView;
@property (nonatomic) TKResizeControl *leftEdgeView;
@property (nonatomic) TKResizeControl *bottomEdgeView;
@property (nonatomic) TKResizeControl *rightEdgeView;
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (UIView *subview in subviews) {
        if ([subview isKindOfClass:[TKResizeControl class]]) {
...
- (CGRect)cropRectMakeWithResizeControlView:(TKResizeControl *)resizeControlView
{
